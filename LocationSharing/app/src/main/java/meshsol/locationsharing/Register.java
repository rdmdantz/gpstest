                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(jobj.getString("msg").equalsIgnoreCase("insertion completed")) {

                                SharePreferences.setPrefUserServerId(getApplicationContext(), jobj.getString("id"));
                                SharePreferences.setPrefUserNumber(getApplicationContext(), phoneNumber);
                                Intent intent = new Intent(Register.this, MapsActivity.class);
                                startActivity(intent);
                                finish();
                            }
