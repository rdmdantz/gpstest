...
public class AppManager {
  //  public  static String url="http://54.251.156.226:80/LocationSharing/controller.php";  //Last used
   ...
   public static String apiKey="AIzaSyBerr5YmJLgMP4Fwbq1C5ZNxs6e-7GXYlU";
    ...
    public static String client_id="946692375436-j12d5guug9gg9euntad44f85gtoedglj.apps.googleusercontent.com";
   // public static String apikey="AIzaSyD4MoFKleKFGPCrcX7hGxKZzINKIdn1Fmg";
